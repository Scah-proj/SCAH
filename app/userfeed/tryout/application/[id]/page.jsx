...
const Page = () => {
  ...
  const [applyToTryout, { isLoading: isApplying }] =
    useApplyToTryoutMutation();
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-16 gap-3">
        ...
        <p className="text-sm text-gray-500">Loading Tryout...</p>
      </div>
    );
  }
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-4">
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-gray-500">
                <span>
                  {tryout.sport} · {tryout.gender}
                </span>
                <span>
                  {tryout.city}, {tryout.venue}
                </span>
              </div>
            </div>
                ...
                <div className="mt-6">
                  {user?.role === "Scout" && isTryoutOwner ? (
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/userfeed/tryout/application/${id}/applicants`
                        )
                      }
                    >
                      View Applicants
                          ...
                          <form className="space-y-6" id="tryout-application-form" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                ...
                                <input
                                  type="text"
                                  placeholder="Position (e.g. ST, GK)"
                                  name="position"
