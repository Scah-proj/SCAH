import
  {
    User, Shield, SquareMinus, Bookmark, History, Bell, BellOff, LockKeyhole, CircleStar,
...
export const settingsSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Archives", path: "/userfeed/settings/appAndMedia/archives", icon: <ArrowDownToLine size={20} /> },
