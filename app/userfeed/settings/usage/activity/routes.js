...
export const activityRoutes = [
  {
    ...
    items: [
      ...
      { label: "Reposts", path: "/userfeed/settings/usage/reposts" , icon: <Repeat2 size={20} />},
  ...
  },
  {
    ...
    items: [
      { label: "Recently deleted", path: "/userfeed/settings/usage/deleted" , icon: <Trash2 size={20} />},
    ],
  },
  {
