...
function getDeadlineStatus(deadline) {
  ...
  if (daysLeft < 0) return { text: "Closed", color: "text-gray-500 bg-gray-100" };
  if (daysLeft === 0) return { text: "Ends Today", color: "text-red-600 bg-red-50" };
  if (daysLeft <= 3) return { text: `${daysLeft} days left`, color: "text-red-600 bg-red-50" };
...
>
  {deadlineInfo.text} · {trial.deadline}
</p>
        </div>
